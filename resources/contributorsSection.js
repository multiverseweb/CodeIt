...
async function fetchData() {
  try {
    const contributorsResponse = await fetch(
      "https://api.github.com/repos/multiverseweb/CodeIt/contributors"
    );
    const contributorsData = await contributorsResponse.json();

    const repoResponse = await fetch(
      "https://api.github.com/repos/multiverseweb/CodeIt"
    );
...
async function fetchData() {
  try {
    ...
    do {
      response = await fetch(`https://api.github.com/repos/multiverseweb/CodeIt/contributors?page=${page}&per_page=100`);
    ...
    const repoResponse = await fetch('https://api.github.com/repos/multiverseweb/CodeIt');
    const repoData = await repoResponse.json();
